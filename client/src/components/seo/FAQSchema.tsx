const faqs = [
  {
    ...
    a: "Most manufacturers recommend at least once per year to maintain warranty compliance and optimal efficiency. Homes with pets, allergies, or heavy use may benefit from cleaning every 6 months. A dirty heat pump can increase energy bills by 10–25%.",
  },
  {
  ...
  },
  {
    ...
    a: "Book online 24/7 at greenpumpcare.ca, call (782) 830-5900, or email info@greenpumpcare.com. We offer flexible scheduling Monday–Friday 8am–8pm and Saturday 10am–5pm (Atlantic Time).",
  },
];
